      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Our team is here to help you get the most out of ReactUI. Choose the
          ...
          <div className="space-y-6 order-2 lg:order-1">
            ...
            <Card className="hover:shadow-md transition-shadow cursor-pointer">
              ...
              <CardContent>
                ...
                >
                  <a
                    href="https://github.com/navariltd/frappe_react_ui_components.git/issues"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    View on GitHub
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea
                              placeholder="Tell us how we can help you with ReactUI components..."
                              rows={10}
                              className="min-h-50"
                              {...field}
                            />
