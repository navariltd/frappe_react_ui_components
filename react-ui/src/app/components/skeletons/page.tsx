...
export default function SkeletonsPage() {
  return (
    <BaseLayout title="Skeletons" description="Skeleton loading components">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Skeleton for text content</CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Complete card skeleton</CardDescription>
              </CardHeader>
              <CardContent>
